...
unsigned char * aes_decrypt_update(AES_CTX * _ctx, unsigned char * cipher, size_t cipher_len, size_t * outlen) {
...
unsigned char * aes_decrypt_final(AES_CTX * _ctx, size_t * outlen) {
  EVP_CIPHER_CTX *ctx = _ctx->decrypt;
...
unsigned char * aes_encrypt_update(AES_CTX * _ctx, unsigned char * plain, size_t plain_len, size_t * outlen) {
...
unsigned char * aes_encrypt_final(AES_CTX * _ctx, size_t * outlen) {
  EVP_CIPHER_CTX *ctx = _ctx->encrypt;
